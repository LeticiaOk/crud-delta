...
if ($_SERVER['REQUEST_METHOD'] == 'GET' && isset($_GET['id'])) {
    ...
    try {
        ...
        if ($stmt->rowCount() > 0) {
            ...
            $mensagem = "Ops.. Erro ao excluir administrador.";
        }
    } catch (PDOException $e) {
        $mensagem =  "Serviço indisponível: não foi possível excluir o administrador.";;
    }
}
?>
    ...
    <main class="main-page">
        ...
        <article class="background-image">
            <main class="main-edit">
                ...
                <img class="titulo-animacao" src="svg/inbox-cleanup-pana.svg" alt="">
